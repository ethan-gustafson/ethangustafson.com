  ...
  <Section>
    ...
    <MainContainer>
      ...
      <InfoContainer>
        ...
        <P>Software engineer transitioning a technical and creative background in filmmaking to the field of web development. My former work required a highly complex and diverse skill set, including the mastery of high-end software editing platforms, hardware tools, client-facing customer service, and project management. Working with Rails and React is a natural step in my career path.</P>
      </InfoContainer>
